...
#i_dates = ['2021-01-01', '2021-02-01', '2021-03-01', '2021-04-01', '2021-05-01', '2021-06-01', '2021-07-01', '2021-08-01', '2021-09-01', '2021-10-01', '2021-11-01']
#f_dates = ['2021-02-01', '2021-03-01', '2021-04-01', '2021-05-01', '2021-06-01', '2021-07-01', '2021-08-01', '2021-09-01', '2021-10-01', '2021-11-01', '2021-12-01']
...
for count_mode in range(0, len(bands)) :
    
    vv_snr = []
    vh_snr = []
    
    mode_val = bands[count_mode]
    print('For band %s' % (mode_val))
    ...
    for count in range(0, len(i_dates)) :
        ...
        # Add scatter plots.
        #ax.scatter(lst_df_urban['datetime'], lst_df_urban[mode_val],
        #           c='black', alpha=0.2, label='Urban (data)')
        #ax.scatter(lst_df_rural['datetime'], lst_df_rural[mode_val],
