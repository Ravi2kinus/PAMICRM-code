...
for count in range(0, len(i_dates)) :
    ...
    #lst_df_urban['VV'] = lst_df_urban['VV'].apply(t_modis_to_celsius)
    
    # Do the same for the rural point.
    #lst_df_rural = ee_array_to_df(lst_r_poi,['VV'])
    #lst_df_rural['VV'] = lst_df_rural['VV'].apply(t_modis_to_celsius)
    ...
    #y_data_u = np.asanyarray(lst_df_urban['VV'].apply(float))  # urban
    #y_data_r = np.asanyarray(lst_df_rural['VV'].apply(float))  # rural
    ...
    # Add scatter plots.
    #ax.scatter(lst_df_urban['datetime'], lst_df_urban['VV'],
    #           c='black', alpha=0.2, label='Urban (data)')
    #ax.scatter(lst_df_rural['datetime'], lst_df_rural['VV'],
